...
exports.StreamingModule = StreamingModule = __decorate([
    (0, common_1.Module)({
        imports: [
            (0, common_2.forwardRef)(() => songs_module_1.SongsModule),
        ],
        providers: [streaming_service_1.StreamingService, media_processor_1.MediaProcessor],
        controllers: [streaming_controller_1.StreamingController],
        exports: [streaming_service_1.StreamingService, media_processor_1.MediaProcessor],
    })
], StreamingModule);
